...
pub mod business {
    ...
    pub use crate::structs::business::business_openings::business_opening_hours::BusinessOpeningHours;
    pub use crate::structs::business::business_openings::business_opening_hours_interval::BusinessOpeningHoursInterval;
...
pub mod chat {
    ...
    pub use crate::structs::updates::chat_boost_added::ChatBoostAdded;
    pub use crate::structs::updates::chat_boost_removed::ChatBoostRemoved;
    pub use crate::structs::updates::chat_boost_updated::ChatBoostUpdated;
...
pub mod dice {
    ...
    pub use crate::structs::dices::options::Options as DiceOptions;
...
pub mod forum {
    ...
    pub use crate::structs::messages::message_kinds::forum_topic_closed::ForumTopicClosed;
    pub use crate::structs::messages::message_kinds::forum_topic_created::ForumTopicEdited;
    pub use crate::structs::messages::message_kinds::forum_topic_edited::ForumTopicCreated;
    pub use crate::structs::messages::message_kinds::forum_topic_reopened::ForumTopicReopened;
    pub use crate::structs::messages::message_kinds::general_forum_topic_hidden::GeneralForumTopicHidden;
    pub use crate::structs::messages::message_kinds::general_forum_topic_unhidden::GeneralForumTopicUnhidden;
...
pub mod inline {
    ...
    pub use crate::structs::inline_query_results::inline_query_result_caches::inline_query_result_cached_audio::InlineQueryResultCachedAudio;
    pub use crate::structs::inline_query_results::inline_query_result_caches::inline_query_result_cached_document::InlineQueryResultCachedDocument;
    pub use crate::structs::inline_query_results::inline_query_result_caches::inline_query_result_cached_gif::InlineQueryResultCachedGif;
    pub use crate::structs::inline_query_results::inline_query_result_caches::inline_query_result_cached_mpeg4_gif::InlineQueryResultCachedMpeg4Gif;
    pub use crate::structs::inline_query_results::inline_query_result_caches::inline_query_result_cached_photo::InlineQueryResultCachedPhoto;
    pub use crate::structs::inline_query_results::inline_query_result_caches::inline_query_result_cached_sticker::InlineQueryResultCachedSticker;
    pub use crate::structs::inline_query_results::inline_query_result_caches::inline_query_result_cached_video::InlineQueryResultCachedVideo;
    pub use crate::structs::inline_query_results::inline_query_result_caches::inline_query_result_cached_voice::InlineQueryResultCachedVoice;
...
pub mod media {
    ...
    pub mod animation {
        ...
        pub use crate::structs::media::options::Options as MediaOptions;
        pub use crate::structs::media::photo_size::PhotoSize;
        pub use crate::structs::messages::message_kinds::animation_received::AnimationReceived as AnimationMessage;
    ...
    pub mod audio {
        ...
        pub use crate::structs::media::options::Options as MediaOptions;
        pub use crate::structs::media::photo_size::PhotoSize;
        pub use crate::structs::messages::message_kinds::audio_received::AudioReceived as AudioMessage;
    ...
    pub mod document {
        ...
        pub use crate::structs::media::options::Options as MediaOptions;
        pub use crate::structs::media::photo_size::PhotoSize;
        pub use crate::structs::messages::message_kinds::document_received::DocumentReceived as DocumentMessage;
    ...
    pub mod media_group {
        pub use crate::enums::file_input::FileInput;
        pub use crate::enums::input_media::InputMedia;
        pub use crate::structs::media::input_media::input_media_animation::InputMediaAnimation;
        pub use crate::structs::media::input_media::input_media_audio::InputMediaAudio;
        pub use crate::structs::media::input_media::input_media_document::InputMediaDocument;
        pub use crate::structs::media::input_media::input_media_photo::InputMediaPhoto;
        pub use crate::structs::media::input_media::input_media_video::InputMediaVideo;
        pub use crate::structs::media::options::Options as MediaOptions;
        pub use crate::structs::media::photo_size::PhotoSize;
    ...
    pub mod video {
        ...
        pub use crate::structs::messages::message_kinds::voice_received::VoiceReceived as VideoMessage;
    ...
    pub mod video_note {
        ...
        pub use crate::structs::messages::message_kinds::voice_received::VoiceReceived as VideoNoteMessage;
    ...
    pub mod voice {
        ...
        pub use crate::structs::messages::message_kinds::voice_received::VoiceReceived as VoiceMessage;
...
pub mod message_reactions {
    pub use crate::structs::messages::reactions::reaction_count::ReactionCount;
    pub use crate::structs::messages::reactions::reaction_type_custom_emoji::ReactionTypeCustomEmoji;
    pub use crate::structs::messages::reactions::reaction_type_emoji::ReactionTypeEmoji;
...
pub mod payments {
    ...
    pub mod order {
        pub use crate::structs::payments::labeled_price::LabeledPrice;
        pub use crate::structs::payments::shippings::shipping_address::ShippingAddress;
        pub use crate::structs::payments::shippings::shipping_option::ShippingOption;
        pub use crate::structs::payments::shippings::shipping_query::ShippingQuery;
    ...
    pub mod star {
        ...
        pub use crate::structs::payments::revenue_withdrawal_states::revenue_withdrawal_state_failed::RevenueWithdrawalStateFailed;
        pub use crate::structs::payments::revenue_withdrawal_states::revenue_withdrawal_state_pending::RevenueWithdrawalStatePending;
        pub use crate::structs::payments::revenue_withdrawal_states::revenue_withdrawal_state_succeeded::RevenueWithdrawalStateSucceeded;
        pub use crate::structs::payments::transaction_partners::transaction_partner_fragment::TransactionPartnerFragment;
        pub use crate::structs::payments::transaction_partners::transaction_partner_other::TransactionPartnerOther;
        pub use crate::structs::payments::transaction_partners::transaction_partner_telegram_ads::TransactionPartnerTelegramAds;
        pub use crate::structs::payments::transaction_partners::transaction_partner_user::TransactionPartnerUser;
...
pub mod passport {
    ...
    pub use crate::structs::passports::encrypted::encrypted_credentials::EncryptedCredentials;
    pub use crate::structs::passports::encrypted::encrypted_passport_element::EncryptedPassportElement;
    pub use crate::structs::passports::passport_data::PassportData;
    pub use crate::structs::passports::passport_element_error::passport_element_error_data_field::PassportElementErrorDataField;
    pub use crate::structs::passports::passport_element_error::passport_element_error_file::PassportElementErrorFile;
    pub use crate::structs::passports::passport_element_error::passport_element_error_files::PassportElementErrorFiles;
    pub use crate::structs::passports::passport_element_error::passport_element_error_front_side::PassportElementErrorFrontSide;
    pub use crate::structs::passports::passport_element_error::passport_element_error_reverse_side::PassportElementErrorReverseSide;
    pub use crate::structs::passports::passport_element_error::passport_element_error_selfie::PassportElementErrorSelfie;
    pub use crate::structs::passports::passport_element_error::passport_element_error_translation_file::PassportElementErrorTranslationFile;
    pub use crate::structs::passports::passport_element_error::passport_element_error_translation_files::PassportElementErrorTranslationFiles;
    pub use crate::structs::passports::passport_element_error::passport_element_error_unspecified::PassportElementErrorUnspecified;
...
pub mod reply_markup {
    ...
    pub use crate::structs::reply_markups::inline_keyboards::inline_keyboard_button::InlineKeyboardButton;
    pub use crate::structs::reply_markups::inline_keyboards::inline_keyboard_markup::InlineKeyboardMarkup;
    ...
    pub use crate::structs::reply_markups::reply_keyboards::reply_keyboard_markup::ReplyKeyboardMarkup;
    pub use crate::structs::reply_markups::reply_keyboards::reply_keyboard_remove::ReplyKeyboardRemove;
}
